...
describe Ai do
  ...
  it "should return position of empty square when two in row are the same but one is empty" do
    board = Board.new
    board.game_state = ['1', '2', '3', '4', '5', 'O', 'X', '8', 'X']
    ai = Ai.new(board)
  ...
  it "should return false if there are two of same but one of other in row" do
    board = Board.new
    board.game_state = ['1', '2', '3', '4', '5', 'O', 'X', 'O', 'X']
    ai = Ai.new(board)
  ...
  it "should block opponents three in a row" do
    board = Board.new
    board.game_state = ['1', '2', '3', 'O', '5', 'O', 'X', 'O', 'X']
    ai = Ai.new(board)
  ...
  it "should return false if center square is already marked" do
    board = Board.new
    board.game_state = ['1', '2', '3', '4', 'X', 'O', 'X', 'O', 'X']
    ai = Ai.new(board)
  ...
  it "should mark first empty corner encountered" do
    board = Board.new
    board.game_state = ['O', '2', '3', '4', 'X', 'O', 'X', 'O', 'X']
    ai = Ai.new(board)
  ...
  it "should return false if no corners are empty" do
    board = Board.new
    board.game_state = ['O', '2', 'X', '4', 'X', 'O', 'X', 'O', 'X']
    ai = Ai.new(board)
  ...
  it "should mark opposite corner of square oppoent has marked" do
    board = Board.new
    board.game_state = ['X', '2', '3', '4', '5', '6', '7', '8', '9']
    ai = Ai.new(board)
  ...
  it "should return false if no opposite corners can be marked" do
    board = Board.new
    board.game_state = ['X', '2', 'O', '4', '5', '6', 'X', '8', 'O']
    ai = Ai.new(board)
  ...
  it "should mark a side square" do
    board = Board.new
    board.game_state = ['X', '2', 'O', '4', '5', '6', 'X', 'O', 'O']
    ai = Ai.new(board)
  ...
  it "should return false if no side square can be marked" do
    board = Board.new
    board.game_state = ['X', 'X', 'X', 'X', 'X', 'X', 'X', 'X', 'X']
    ai = Ai.new(board)
